...
import { footerLinks } from "@/constants"; // iz foldera constants ubacujemo podatke koje smo kreirali, da bi lakse napravili footer //
    ...
    <footer className="flex flex-col text-black-100 mt-5 border-t border-gray-100">
      <div className="flex max-md:flex-col flex-wrap justify-between gap-5 px-6 py-10 sm:px-16">
        ...
        <div className="footer__links">
          {footerLinks.map(
            (
              link // mapiramo kroz podatke i linkove za footer //
            ) => (
